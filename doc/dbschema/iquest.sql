...
CREATE TABLE IF NOT EXISTS `event` (
  ...
  `type` enum('team_logged','key_entered','logout','giveitup','coin_gain','coin_spend','blow_up','location_check','timeshift') COLLATE utf8_czech_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `team` (
  ...
  `tracker_id` VARCHAR(255) NOT NULL DEFAULT '' COLLATE utf8_czech_ci,
  `time_shift` TIME NOT NULL DEFAULT '00:00:00',
  PRIMARY KEY (`team_id`),
